...
class TestGLiNEROptionalIntegration:
    ...
    def test_redactyl_works_without_gliner(self):
        ...
        unredacted_text, _ = redactyl.unredact(redacted_text, state)
    ...
    def test_detector_with_explicit_gliner_disable(self):
        ...
        assert detector.gliner_parser is None
        ...
        _found_types = {e.type.value for e in entities}
    ...
    def test_gliner_parser_availability_check(self):
        ...
        if not is_available:
            ...
            entity = PIIEntity(type=PIIType.PERSON, value="John Doe", start=0, end=8, confidence=0.9)
    ...
    def test_warning_when_gliner_requested_but_unavailable(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            gliner_warnings = [warning for warning in w if "GLiNER" in str(warning.message)]
    ...
    def test_consistent_api_with_and_without_gliner(self, use_gliner: bool) -> None:
